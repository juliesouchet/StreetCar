...
// TODO
		this.tileDirection			= t.tileDirection.getClone();
	...
	public Tile getClone()
	{
		...
		res.tileDirection		= this.tileDirection.getClone();
...
// --------------------------------------------
	...
	public Direction getTileDirection()	{return this.tileDirection.getClone();}
...
// --------------------------------------------
	public static class Path implements Serializable, CloneableInterface<Path>
	{
		...
		{
			this.end0	= d0.getClone();
			this.end1	= d1.getClone();
		}
		private Path(){}
		public Path getClone()
		{
			Path res = new Path();
			res.end0 = this.end0.getClone();
			res.end1 = this.end1.getClone();
			return res;
		}
		// Setter
		public void turnLeft()	{end0.turnLeft();	end1.turnLeft();}
		public void turnRight()	{end0.turnRight();	end1.turnRight();}
		public void turnHalf()	{end0.turnHalf();	end1.turnHalf();}
